        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={5}
              className="flex w-full rounded-md border border-[var(--surface-border)] bg-[var(--surface-base)] px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ember)] focus-visible:ring-offset-2"
